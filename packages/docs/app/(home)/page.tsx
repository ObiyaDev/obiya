...
export default function HomePage() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen py-16 landscape:py-8 px-6 sm:px-4">
      <div className="w-full sm:w-auto text-center max-w-5xl mx-auto landscape:my-4">
        <h1 className="text-[36px] xs:text-[42px] sm:text-[72px] md:text-[86px] font-[950] leading-tight mb-2 landscape:mb-1">
          <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
            Code-First
          </span> Framework
        </h1>

        <h2 className="text-[28px] xs:text-[32px] sm:text-[56px] md:text-[64px] font-[800] dark:text-gray-300 text-gray-700 mb-8 landscape:mb-4">
          for <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
            Intelligent Workflows
          </span>
        </h2>

        <p className="text-lg sm:text-xl dark:text-gray-400 text-gray-600 max-w-3xl mx-auto tracking-[-0.02em] font-light px-2 mb-8 landscape:mb-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-2 mb-8 landscape:mb-4">
          <Link
        ...
        <div className="w-full sm:w-auto flex justify-center">
          <div
            ...
            onClick={handleCopy}
          >
            <div className="inline-flex items-center dark:bg-[#0a0a0a] bg-gray-100 px-4 py-2.5 dark:text-gray-300 text-gray-700 
                         font-mono text-sm border dark:border-gray-700 border-gray-200 rounded-md select-none overflow-x-auto">
              <span className="dark:text-gray-500 text-gray-400 shrink-0">~</span>
              <span className="ml-2 scrollbar-hide whitespace-nowrap">npx motia create -t default -n new-project</span>
            </div>

  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full px-4 bg-transparent flex-1">
      <div className="text-center max-w-5xl">
        <h1 className="text-[56px] sm:text-[72px] md:text-[86px] font-[950] leading-tight mb-2">
          <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
            Code-First
          </span> Framework
        </h1>
        <h2 className="text-[42px] sm:text-[56px] md:text-[64px] font-[800] dark:text-gray-300 text-gray-700 mb-8">

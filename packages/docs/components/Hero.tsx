      ...
      <div className="flex h-screen w-full flex-col items-end max-lg:items-start max-lg:pl-[16px]">
        ...
        <div className="fade-bottom relative z-1 flex min-w-[50vw] overflow-hidden max-2xl:min-w-[60vw] max-lg:w-full max-md:h-[100vh] xl:h-[65vh]">
          <Image
            ...
            priority={true}
            placeholder="blur"
            className="fade-bottom absolute top-0 left-0 w-full rounded-t-[10px] bg-black object-cover object-top-left max-2xl:min-w-[60vw] max-md:min-h-[600px]"
            src={bgHeroDashboard}
            alt={'hero'}
          />
          <div className="relative flex h-full w-full items-start gap-y-[20px] px-8 pt-[90px] max-md:flex-col max-md:pt-[60px] lg:justify-between">
            <Image
              width={500}
              priority={true}

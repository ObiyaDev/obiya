...
const TAB_LIST = [AGENT_TRELLO, AGENT_GMAIL, AGENT_PDF, AGENT_FINANCE]
const icons = [trelloIcon, gmailIcon, pdfIcon, financeIcon]
const transition = {
  type: 'spring',
  mass: 0.15,
  damping: 20,
          ...
          return (
            ...
            >
              <IconWrapper tab={tab} variant={tab === agent ? 'active' : 'inactive'}>
                <div className="w-full max-w-[22px]">{icons[i]}</div>
              </IconWrapper>

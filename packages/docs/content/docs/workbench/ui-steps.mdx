...
| ----------- | -------------- | ------------------------------- |
| EventNode   | EventNodeProps | Will override an EventNode look |
| ApiNode     | ApiNodeProps   | Will override an ApiNode look   |
| CronNode    | CronNodeProps  | Will override an CronNode look  |
| NoopNode    | NoopNodeProps  | Will override an NoopNode look  |

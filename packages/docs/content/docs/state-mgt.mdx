...
Don't forget to checkout the [best practices](/docs/happy-practices#best-practices-of-using-state-manager) of using State Manger when writing Motia apps.
</Callout>

## Next Steps
Now that we’ve seen how to use the state manager to store and retrieve data across steps, it’s time to take our workflows further.

Whether you’re preparing your flows for production or just want to improve how you test and debug your stateful logic, these resources will help:
<Cards>
  <Card
    title="🚀 Deployments"
  ...
  <Card
    ...
    href="/docs/happy-practices#best-practices-of-using-state-manager"
  />
</Cards>
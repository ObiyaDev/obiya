...
Following is an architectural overview of how Motia apps work:
  ...
  ![old way is to juggle a bunch of different things together while the new way is simply using steps](./img/image(4).png)
...
_Just like React has components, Motia has Steps._
...
- If you need any support or just want to interact with your fellow community members, our community is always there for you.
- If you love Motia and want to contribute to it, here's how you can.

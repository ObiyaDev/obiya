...
- [Example Motia project with deployment boilerplate for AWS LightSail and Railway](https://github.com/MotiaDev/motia-docker/tree/main/examples/motia-docker-example)

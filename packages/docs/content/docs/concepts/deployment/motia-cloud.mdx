...
```bash
export MOTIA_API_KEY=your-api-key-here
export MOTIA_PROJECT_ID=my-project-id
export MOTIA_ENVIRONMENT_ID=production
export MOTIA_PROJECT_NAME="My Production Project"

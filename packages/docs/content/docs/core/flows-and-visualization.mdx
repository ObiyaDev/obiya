...
After you've defined your flows, you can visualize them in [Motia Workbench](/docs/core/workbench).
...
Checkout the [Motia Workbench](/docs/workbench/overview) guide for more information.

...
export const statesSteps: TutorialStep[] = [
  {
    ...
    description: `Ok now that we've seen the observability tools, let's take a look at the state management tool.`,
    id: uuidv4(),
  ...
  },
  {
    ...
    description: `This is your state management tool, from here you will be able to see all of your persisted state key/value pairs.`,
    id: uuidv4(),
  ...
  },
  {
    ...
    segmentId,
    title: 'State Details',
    description: `This is your state details view, from here you will be able to manage the value assigned to the selected state key.`,
    id: uuidv4(),
